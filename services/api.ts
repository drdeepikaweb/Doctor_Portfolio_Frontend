...
export const api = {
  ...
  requestResetPasswordOtp: (email: string) => request<{ message: string }>("/doctors/reset-password/request", { method: "POST", body: JSON.stringify({ email }) }),
  verifyResetPasswordOtp: (email: string, otp: string) => request<{ message: string }>("/doctors/reset-password/verify", { method: "POST", body: JSON.stringify({ email, otp }) }),
  resetPassword: (data: unknown) => request<{ message: string }>("/doctors/reset-password/reset", { method: "POST", body: JSON.stringify(data) }),
